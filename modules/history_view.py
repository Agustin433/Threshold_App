"""Gestion de historial local y remoto.

Vivia en `pages/06_history_manager.py`. Se movio a un modulo con una funcion
de render para que sea una vista principal mas, y no una navegacion paralela
en el menu lateral de Streamlit.
"""
